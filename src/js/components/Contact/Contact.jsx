      ...
      <div id="contact">
        <div className="row">
          <div className="medium-6 small-10 medium-centered small-centered columns">
            <h3>Lets talk</h3>
            <ul>
              <li><a target="_blank" href="https://twitter.com/danielravina"><i className="icon icon-twitter-square"></i></a></li>
              <li><a target="_blank" href="https://github.com/danielravina"><i className="icon icon-github-square"></i></a></li>
              <li><a target="_blank" href="https://www.linkedin.com/pub/daniel-ravina/67/6a9/a10"><i className="icon icon-linkedin-square"></i></a></li>
            </ul>
