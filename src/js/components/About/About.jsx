      ...
      <div id="about">
        ...
        <div className="row">
          <div className="medium-6 small-10 medium-centered small-centered columns">
            ...
            <p>
              {"In my free time you'll probably find me at a"} <a target='_blank' href='http://www.meetup.com/members/145250932/'>local tech meetup</a>{", experimenting with cool new technologies or contributing to open source projects."}
            </p>
          </div>
        </div>
      </div>
