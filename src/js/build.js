...
/***/ function(module, exports, __webpack_require__) {
	...
	var React       = __webpack_require__(1);
	var Colors      = __webpack_require__(162) // " 'data' is an alias in webpack config"
	...
	var Tag = React.createClass({displayName: "Tag",
	  ...
	  render: function() {
	    return (
	      React.createElement("li", {style: this.getStyle(), className: this.getClass()}, 
	        this.props.tech
	      )
	    );
	  },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React      = __webpack_require__(1);
	var Column     = __webpack_require__(164);
	...
	var Grid = React.createClass({displayName: "Grid",
	  ...
	  render: function() {
	    ...
	    return (
	      React.createElement("div", {className: "react-grid"}, 
	        rows
	      )
	    )
	  },
	  ...
	  generateRow: function(from, to) {
	    ...
	    return(
	      React.createElement(Row, {key: from}, 
	        columnsPerRow
	      )
	    )
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Column = React.createClass({displayName: "Column",
	  ...
	  render: function() {
	    return React.createElement("div", {style: this.state.transition, className: this.columnToSpace()  + " columns " + this.state.transitionClass}, this.props.children)
	  },
	...
	var Modal = React.createClass({displayName: "Modal",
	  ...
	  render: function() {
	    ...
	    return (
	      React.createElement("div", {className: "modal active"}, 
	        ...
	        React.createElement("div", {className: "content", style: this._imagesExists() || this._hasVideo() ? {} : {top: "15%"}}, 
	  ...
	  renderGallery: function() {
	    if(this._imagesExists()) {
	      ...
	      return(React.createElement("div", {className: "iframeWrapper"}, 
	        React.createElement("iframe", {src: this.props.project.video, width: '800px', height: '400px'})
	      ));
	    } else {
	      return (
	...
	var ImageGallery = _react2['default'].createClass({
	  ...
	  renderArrows: function renderArrows() {
	    if (this.props.items.length >= 2) {
	      return [_react2['default'].createElement('a', { className: 'image-gallery-left-nav',
	        onTouchStart: this.swipePrev,
	        onClick: this.swipePrev }), _react2['default'].createElement('a', { className: 'image-gallery-right-nav',
